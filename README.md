...
- I love working on **backend services** and **data engineering pipelines**.  
- Interested in **AWS Cloud solutions** and scalable web architectures.  
- Constantly improving **full-stack skills** with **Next.js**, **React**, and **NestJS**.  
- Building projects that combine **data engineering, analytics, and backend APIs**.  
